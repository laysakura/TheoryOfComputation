...
%\usepackage{type1cm}% PS, PDF 作成には必要となる場合もある。
...
\subsubsection{\cmd{defineEMpsCMYKcolor}}
...
\end{verbatim}
\end{jquote}
をご覧ください。その他のカラーを使用したいときは\cmd{defineEMpsCMYKcolor}コマンドで
定義してください。

\begin{showEx}(.64,.3){\cmd{defineEMpscolor}}
  \begin{pszahyou}[ul=10mm](-1.2,1.5)(-1.2,1.5)
    \defineEMpsCMYKcolor{江戸紫}%
        {0.80}{0.86}{0.30}{0}
    \begin{EMpscolor}{江戸紫}
      \En\O{1}
    \end{EMpscolor}
